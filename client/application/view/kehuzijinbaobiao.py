...
# Form implementation generated from reading ui file 'ui/kehuzijinbaobiao.ui'
#
# Created: Wed Mar 18 18:50:23 2015
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "变更类型：", None))
        ...
        item.setText(_translate("Dialog", "期初余额(元)", None))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "收入(元)", None))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Dialog", "支出(元)", None))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Dialog", "期末余额(元)", None))
