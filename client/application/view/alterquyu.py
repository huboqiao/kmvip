...
# Form implementation generated from reading ui file 'alterquyu.ui'
#
# Created: Wed Feb 11 15:59:24 2015
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "添加区域", None))
        self.label.setText(_translate("Dialog", "区域名称：", None))
        self.label_2.setText(_translate("Dialog", "状态：", None))
        self.comboBox.setItemText(0, _translate("Dialog", "禁用", None))
